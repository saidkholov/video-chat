...
app.get('/conference/:room', homeController.conference);
...
var expressPeerServer = ExpressPeerServer(httpsServer);
var connected = [];
...
httpsServer.listen(3030, () => {
  console.log('Express server listening on port %d in %s mode', 3030, app.get('env'));
});
